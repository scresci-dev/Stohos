...
let message2 = TutorialMessage(textMessage: "According to Minimalism as a state of mind, a thought is Essential when it brings you joy and has a vital meaning for you", imageName: "Rosa1", sizeFont: 18, boldWord: "Essential")
let message3 = TutorialMessage(textMessage: "A thought is Non-Essential when it can lead you to focus only on the negative and waste valuable mental energy", imageName: "Verde1", sizeFont: 18, boldWord: "Non-Essential")
